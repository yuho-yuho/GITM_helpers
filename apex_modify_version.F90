...
!-----------------------------------------------------------------------
subroutine cofrm(date0) ! yuhong, 03/01/2024 
  implicit none
!
! Input arg:
  real,intent(in) :: date0 ! yuhong, 03/01/2024 
!
! Local:
  integer :: m,n,i,l,ll,lm,nmx,nc,kmx,k,mm,nn
  real :: t,one,tc,r,f,f0,date ! yuhong, 03/01/2024
